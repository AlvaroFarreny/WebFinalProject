...
<body>
    ...
    <section class="introduccion">
        <div>
            ...
            <p class="texto">Liga de Bolsa es la mayor comunidad de clubs de inversión de España. Organizamos
                competiciones de inversión con dinero real en las que podrás demostrar tus cualidades como gestor. Únete
                y compite por los increíbles premios.</p>
        </div>
    </section>
    <section class="desarrollo">
        <div>
            <h3 class="titulos-h3"><strong>¿Qué vamos a hacer?</strong></h3>
            <p class="texto">La Liga de Bolsa Universitaria comienza el día 14 de noviembre de 2022 y finaliza el último
                día de bolsa de octubre de 2023. Dura prácticamente un año y en cuanto acaba una edición comienza la
                siguiente. Ten en cuenta que el plazo de inscripción finaliza el 14 de diciembre, un mes después del
                inicio de la Liga.
                <br>
                El objetivo de la Liga es conseguir junto con tu club de bolsa la mayor rentabilidad posible a lo largo
                de la competición. Para ello, competirás contra otros clubes de inversión de distintas universidades y
                escuelas de negocio de toda España.
                Habrá premios para los 10 clubes con mayor rentabilidad al finalizar la competición, así como un premio
                mensual al club con mayor rendimiento cada mes.
            </p>
        </div>
    </section>
    <center>
        <form action="registro_proyectos_PROCESS.php" method="post">
            <input type="submit" name="apuntarse_ligabolsa" value="Registrarme en el Club">
        </form>
    </center>
